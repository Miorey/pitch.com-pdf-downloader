...
if __name__ == '__main__':
    ...
    parser.add_argument('--disable-headless', action='store_true', dest='disable_headless',
                        help='Disable headless mode')
    parser.add_argument('--skip-ocr', action='store_true', dest='skip_ocr', help='Disable OCR')
    parser.add_argument('--skip-border-removal', action='store_true', dest='skip_border_removal',
